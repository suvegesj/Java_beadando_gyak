...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Nov 27. 15:15
...
(1, 'Vasas FC\r'),
(2, 'Ferencvárosi TC\r'),
(3, 'Puskás Akadémia FC\r'),
(4, 'Debreceni VSC\r'),
(5, 'Budapest Honvéd FC\r'),
(6, 'Szombathelyi Haladás\r'),
(7, 'Paksi FC\r'),
(8, 'Mezőkövesd Zsóry FC\r'),
(9, 'Diósgyőri VTK\r'),
(10, 'Újpest FC\r'),
(11, 'Balmazújváros FC\r'),
(12, 'Videoton FC');
...
CREATE TABLE `labdarugo` (
  ...
  `utonev` varchar(12) NOT NULL,
  `vezeteknev` varchar(12) NOT NULL,
  `szulido` date NOT NULL,
  `magyar` int(3) NOT NULL,
  `kulfoldi` int(3) NOT NULL,
  `ertek` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(75, 28, 3, 6, 'Stipe', 'Bacelic-Grgi', '1988-02-16', 0, -1, 300),
...
(93, 16, 10, 4, 'Anton', 'Jönsson Salé', '1996-04-12', 0, -1, 250),
...
(245, 35, 10, 9, 'Bence', 'Gundel-Takác', '1998-04-06', -1, 0, 50),
...
(1, 'bal oldali védő\r'),
(2, 'jobb oldali középpályás\r'),
(3, 'bal szélső\r'),
(4, 'védekező középpályás\r'),
(5, 'bal oldali középpályás\r'),
(6, 'belső középpályás\r'),
(7, 'jobb szélső\r'),
(8, 'jobb oldali védő\r'),
(9, 'kapus\r'),
(10, 'középcsatár\r'),
(11, 'középső védő\r'),
(12, 'támadó középpályás\r'),
(13, 'hátravont csatár\r'),
(14, 'jobboldali védő\r');
